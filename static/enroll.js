var countryoptions = [{label: "Afghanistan",  value: "Afghanistan"}, 
    ...
    $.ajax({
        ...
        success: function(data) { 
            ...
            for (country of Object.keys(data['ScreeningPlot']).reverse()){
                ...
                var enrollTrace = {x: data['EnrolledPlot'][country]['Dates'], y: data['EnrolledPlot'][country]['Enrolled'], name: country, stackgroup: 'one', line: {color: ''}};
                enrollTraces.push(enrollTrace);
            };
            scrollUp();
            var horizBarPlots = {'Screeners': [countryScreenPlotData[0],countryScreenPlotLayout], 'Screen Fail Rate': [countryScreenFailPlotData[0],countryScreenFailPlotLayout], 'Rand': [countryEnrolledPlotData[0],countryEnrolledPlotLayout], 'Enrollment Rate': [countryEnrollRatePlotData[0],countryEnrollRatePlotLayout]};
